...
def generate_captcha(PATH=PWD):
    '''
        ...
        Description:
            ...
            generated captha image is not encrypted, this module simply generate a image for the random character value
            if you want to encrypting captcha library, you should find other library like python-recaptcha or something.
    '''
    with tempfile.NamedTemporaryFile(suffix='.jpg', dir=PATH, delete=False) as fp:
